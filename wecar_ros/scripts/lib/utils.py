    ...
    def steering_angle(self):
        ...
        for i in self.path.poses :
            ...
            if rotated_point.x>0 :
                ...
                # print("dis {%.3f} lfd {%d}" % (dis, self.lfd))
                ...
                if dis>= self.lfd :
                    ...
                    #self.lfd=self.current_vel / 1.1
                    self.lfd=self.current_vel / 3.3
                    #self.lfd=self.current_vel / 3.5
...
def latticePlanner(ref_path,global_vaild_object,vehicle_status,current_lane):
    ...
    # look_distance=int(vehicle_status[3]*3.6*10) -> 승우님이 한거
    look_distance=int(vehicle_status[3]*3.6*3)
    # print("look_dist :", look_distance)
    if look_distance < 5 :
    ...
    if len(ref_path.poses)>look_distance :
        ...
        lane_off_set=[1.0,0.8,0.4,0,-0.4,-0.8,-1.0]
